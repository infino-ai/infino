...
use infino::{connect, Bm25Stats, BoolMode, IndexSpec, Metric, VectorFilter, VectorSearchOptions};
...
let keyword =
    docs.bm25_search("body", "cancel subscription", 5, BoolMode::Or, Bm25Stats::PerSuperfile, None)?;
