...
class Table:
    ...
    def format_versions(self) -> FormatVersionsReport: ...
...
class SuperfileFormatVersions:
    ...
    @property
    def fts_version(self) -> int | None: ...
    @property
    def vector_version(self) -> int | None: ...
    @property
    def id_sidecar(self) -> bool: ...
    @property
    def current(self) -> bool: ...
    def __repr__(self) -> str: ...

class ManifestFormatVersions:
    @property
    def format_version(self) -> str: ...
    @property
    def options_hash_rule(self) -> str: ...
    @property
    def current(self) -> bool: ...
    def __repr__(self) -> str: ...

class FormatVersionsReport:
    @property
    def manifest(self) -> ManifestFormatVersions | None: ...
    @property
    def superfiles(self) -> list[SuperfileFormatVersions]: ...
    @property
    def is_current(self) -> bool: ...
    @property
    def stale_superfiles(self) -> int: ...
    def __repr__(self) -> str: ...
